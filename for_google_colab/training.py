...
def _define_args():
    ...
    parser.add_argument('--slide-parent-folder', type=str, default='Warsztaty-badawcze/Selected_Data', metavar='PATH',
                        help='path of parent folder containing preprocessed slides data')
    parser.add_argument('--slide-labels-filepath', type=str, default='Warsztaty-badawcze/Selected_Data/labels.csv',
                        metavar='PATH',
